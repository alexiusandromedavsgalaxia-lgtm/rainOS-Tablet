...
const svgRepoAssets = {
  photos: 'https://www.svgrepo.com/show/436181/image-picture-gallery.svg',
  messages: 'https://www.svgrepo.com/show/50042/chat-messages.svg',
  settings: 'https://www.svgrepo.com/show/247943/settings-gear.svg',
};
...
function IconGraphic({ appId, symbol }) {
  ...
  if (svgRepoAssets[appId]) {
    return <img className="app-icon-svg app-icon-svg-repo" src={svgRepoAssets[appId]} alt="" draggable="false" />;
  }
