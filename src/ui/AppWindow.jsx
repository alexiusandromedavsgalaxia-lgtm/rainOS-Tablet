      ...
      <header className="app-window-toolbar">
        <div className="window-leading">
          <div className="window-controls" aria-label="Controles de ventana">
            <button ref={closeRef} className="window-control close" onClick={onClose} aria-label="Cerrar ventana" />
            <button className="window-control minimize" onClick={onToggleMode} aria-label="Minimizar ventana" />
            <button className="window-control expand" onClick={onToggleMode} aria-label="Pantalla completa" />
          </div>
          <div className="window-title">
            <span className={`window-title-icon icon-art icon-art-${app.id}`} />
